                ...
                <form method="">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="organisasi" id="organisasi" required>
                            ...
                            <!-- ORMAWA INTI -->
                            <option value="DPM (Dewan Perwakilan Mahasiswa)">DPM (Dewan Perwakilan Mahasiswa)</option>
                            <option value="BEM (Badan Eksekutif Mahasiswa)">BEM (Badan Eksekutif Mahasiswa)</option>
                            ...
                            <!-- UKM KEROHANIAN -->
                            <option value="KMHD (Komunitas Mahasiswa Hindu Dharma)">KMHD (Komunitas Mahasiswa Hindu
                                Dharma)
                            </option>
                            <option value="MCOS (Moslem Community of STIKOM Bali)">MCOS (Moslem Community of STIKOM
                                Bali)
                            </option>
                            <option value="PMK (Persaudaraan Mahasiswa Kristen)">PMK (Persaudaraan Mahasiswa Kristen)
                            </option>
                            ...
                            <option value="JUSTIFY (Jurnalistik STIKOM Family)">JUSTIFY (Jurnalistik STIKOM Family)
                            </option>
                            <option value="UKM Multimedia">UKM Multimedia</option>

                            <!-- UKM OLAHRAGA -->
                            <option value="BOSS (Badminton of STIKOM Bali)">BOSS (Badminton of STIKOM Bali)</option>
                            <option value="UKM Basket">UKM Basket</option>
                            <option value="UKM Futsal">UKM Futsal</option>
                            <option value="GHoST (Gymnastic and Healthy of STIKOM Bali)">GHoST (Gymnastic and Healthy of
                                STIKOM Bali)</option>

                            <!-- UKM TEKNOLOGI -->
                            <option value="PROGRESS (Programmers of STIKOM Bali)">PROGRESS (Programmers of STIKOM Bali)
                            </option>
                            <option value="KSL (Kelompok Studi Linux)">KSL (Kelompok Studi Linux)</option>
                            <option value="RADE (Robotics and Embedded System)">RADE (Robotics and Embedded System)
                            </option>
                            ...
                            <option value="JCOS (Japanese Community of STIKOM Bali)">JCOS (Japanese Community of STIKOM
                                Bali)
                            </option>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="visiMisi" rows="3"></textarea>
                    </div>
